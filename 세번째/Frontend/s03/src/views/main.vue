...
<div id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-left" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>환영합니다 <span>가게를 부탁해</span></h1>
          <h2>회원가입을 하고 혜택을 누려보세요</h2>

          <div class="btns">
            <a @click="signup()" class="btn-menu animated fadeInUp scrollto">회원가입</a>
            <a @click="storesignup()" class="btn-book animated fadeInUp scrollto">식당가입</a>
          </div>
        </div>
